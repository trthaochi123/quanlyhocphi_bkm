...
<head>
    ...
    <title>Kế Toán Viên - Chỉnh sửa</title>
</head>
...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Chỉnh sửa Kế Toán Viên</h3>
                <div class="add-form">
                        ...
                        @foreach ($accountant as $accountant)
                            <div class="inputs-list">
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $accountant->accountant_name }}" name="accountant_name"
                                        type="text" id="accountant_name" class="form-control form-control-sm" />
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $accountant->accountant_phone }}" name="accountant_phone"
                                        type="text" id="accountant_phone" class="form-control form-control-sm" />
                                ...
                                <div class="mt-3 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                            ...
                                            <input value="{{ $accountant->province }}" name="province" type="text"
                                ...
                                @endif
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                            ...
                                            <input value="{{ $accountant->district }}" name="district"
                                                type="text" id="district" class="form-control form-control-sm" />
                                ...
                                @endif
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                            ...
                                            <input value="{{ $accountant->street }}" name="street" type="text"
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $accountant->email }}" name="email" type="text"
