...
<head>
    ...
    <title>Phương Thức Thanh Toán - Sửa</title>
</head>
...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Sửa Phương Thức Thanh Toán</h3>
                <div class="add-form">
                    <form method="post" action="{{ route('payment_methods.update', $id) }}">
                        ...
                        @foreach ($payments as $payment)
                            <div class="inputs-list">
                                <div class="mt-3 mb-3">
                                    <label style="width: 400px;" for="name">Tên Phương Thức Thanh Toán</label>
                                    <input value = "{{ $payment->name }}" name="name" type="text"
                                        id="payMethodName" class="form-control form-control-sm" />
                                    @if ($errors->has('name'))
