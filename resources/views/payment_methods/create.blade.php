...
<head>
    ...
    <title>Phương Thức Thanh Toán - Thêm</title>
</head>
...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Thêm Phương Thức Thanh Toán</h3>
                <div class="add-form">
                    <form method="post" action="{{ route('payment_methods.store') }}">
                        ...
                        <div class="inputs-list">
                            <div class="mt-3 mb-3">
                                <label style="width: 300px" for="name">Tên Phương Thức Thanh Toán</label>
                                <input name="name" type="text" id="payMethodName"
