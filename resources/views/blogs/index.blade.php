...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Danh Sách Bài Đăng</h3>
                            ...
                            <tbody>
                                @foreach ($blogs as $blog)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset(\Illuminate\Support\Facades\Storage::url('Admin/') . $blog->image) }}"
                                                width="100px" height="100px">
                                        </td>
                                        <td>{{ $blog->posting_date_time }}</td>
                                        <td class="btn-edit">
