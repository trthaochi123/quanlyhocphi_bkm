...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Tạo Bài Đăng</h3>
                <div class="add-form">
                    <form method="post" action="{{ route('blogs.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="inputs-list">
                            <div class="mt-3 mb-3">
                                ...
                                <input name="title_blog" type="text" id="title_blog"
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <input name="description_blog" type="text" id="description_blog"
                                    class="form-control form-control-sm" />
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <textarea name="content_blog" type="text" id="content_blog" class="form-control" rows="5"></textarea>
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <input name="posting_date_time" type="datetime-local" id="posting_date_time" />
