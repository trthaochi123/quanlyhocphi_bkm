...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Sửa Kiểu Đóng</h3>
                <div class="add-form">
                        ...
                        @foreach ($payments as $payment)
                            <div class="inputs-list">
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $payment->payment_type_name }}" name="payment_type_name"
                                        type="text" id="payment_type_name" class="form-control form-control-sm" />
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $payment->discount }}" name="discount" type="text"
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $payment->payment_times }}" name="payment_times" type="text"
                                        id="payment_times" class="form-control form-control-sm" />
